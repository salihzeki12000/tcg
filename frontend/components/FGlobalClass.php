    ...
    public function init()
    {
        ...
        if(isset($_SERVER['QUERY_STRING']) && !empty($_SERVER['QUERY_STRING']) && strpos($_SERVER['QUERY_STRING'], 'action=')===0){
            ...
            $url_dir = [
                ...
                'action=guide/list' => '/aboutus/our-guides',
                ...
                'action=admin/viewStaff' => '/aboutus/meet-our-team',
                ...
                'action=aboutUs/officeLocation' => '/aboutus/contact-us',
                'action=aboutUs/driversVehicles' => '/about/drivers-and-vehicles',
