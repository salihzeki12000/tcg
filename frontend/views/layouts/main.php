    ...
    <div class="modal" id="m-menu" tabindex="-1" role="dialog" aria-labelledby="m-menu-label" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <ul class="">
            ...
            <li class="">
                <ul class="menu-group row">
                    <li class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-menu-col-left"><a href="<?= Url::toRoute(['destination/index']) ?>"><?= Yii::t('app','Destinations') ?></a></li>
                    <li class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-menu-col-right"><a href="<?= Url::toRoute(['article/index']) ?>"><?= Yii::t('app','Blog') ?></a></li>
                </ul>
            </li>
            <li class="">
                <ul class="menu-group row">
                    <li class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-menu-col-left"><a href="<?= Url::toRoute(['preparation/index']) ?>"><?= Yii::t('app','Preparation') ?></a></li>
                    <li class="col-lg-6 col-md-6 col-sm-6 col-xs-6 m-menu-col-right"><a href="<?= Url::toRoute(['/faq']) ?>"><?= Yii::t('app','FAQ') ?></a></li>
                </ul>
            </li>
        </ul>
        <ul class="">
