...
<div class="form-feedback-form">
    ...
    <?= $form->field($model, 'rate', ['labelOptions' => ['style' => 'font-weight: normal', 'class' => 'control-label']])->dropDownList([Yii::t('app','Excellent') => Yii::t('app','Excellent'), Yii::t('app','Very Good') => Yii::t('app','Very Good'), Yii::t('app','Average') => Yii::t('app','Average'), Yii::t('app','Poor') => Yii::t('app','Poor')], ['prompt' => Yii::t('app','')]) ?>
