...
$this->title = Yii::t('app','Private and Guided China Tours, China Travel Agency');
...
$this->keywords = Yii::t('app','China tours, China travel guide, China travel agency');
?>
<div class="site-index">
    ...
    <div class="slide-video">
        <video width="100%" loop=1 autoplay=1 poster="https://www.thechinaguide.com/uploads/201702/23/58aee9ea9a2fe.jpg">
          ...
          <?= Yii::t('app',"Your browser doesn't support HTML5 video tag.") ?>
        </video>
      ...
      <div class="carousel-inner full-w">
        ...
        ?>
            <a class="item <?= ($i==0)? 'active' : '' ?> " href="<?= $slide['url'] ?>">
              ...
              <div class="carousel-caption" style="background-color: rgba(0,0,0,0.3); padding-top: 10px">
                <h3><?= $slide['title'] ?></h3>
...
?>
    ...
    <h1 class="container home-desc col-lg-9 col-md-10 col-sm-10 col-xs-12">
        <?=Yii::t('app','We are a Beijing-based travel agency run by a multilingual team of native speakers. With our Western-style travel sense and passion for Chinese culture and history, we can customize your perfect China tour!')?>
    </h1>
    ...
    <div class="container home-categories">
        ...
        <div class="row">
            ...
            ?>
            	<li class="col-lg-4 col-md-6 col-sm-6 col-xs-12 list-group-item">
                <a class="homepage-category" href="<?= Url::toRoute(['experience/index', 'theme'=>$theme['url_id']]) ?>">
            ...
            <?php foreach ($cities_map as $city_info) { ?>
              <article class="entry teaser entry-map-homepage" id="city-map-detail-<?= $city_info['id'] ?>" <?= ($city_info['id']==1) ? '': 'style="display: none;"' ?>>
                ...
                <div class="entry-content" itemprop="text">
                    <img src="<?= Yii::$app->params['uploads_url'] . UploadedFiles::getSize($city_info['pic_s'], 's')?>" class="post-image entry-image" alt="<?= $city_info['name'] ?>" itemprop="image">
    ...
    <div class="container clients-saying">
        <div class="row">
	        ...
	        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 quote">
    ...
    <div class="container clearfix">
        <div class="row">
            ...
            <div class="col-lg-12">
		        <div class="strike">
					<h2>
						<?=Yii::t('app',"Where We're Featured")?>
				   	</h2>
				</div>
			</div>
